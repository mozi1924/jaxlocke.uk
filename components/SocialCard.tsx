...
export const SocialCard: React.FC = () => {
  ...
  return (
    <div className="perspective-1000 w-full max-w-md mx-auto aspect-[1.58/1]">
      ...
      >
        {/* Front of Card */}
        <div className="absolute inset-0 bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 rounded-xl overflow-hidden shadow-2xl shadow-fuchsia-900/20">
          ...
          <div className="relative z-20 h-full flex flex-col justify-between p-8">
            <div className="flex justify-between items-start">
              <div>
                <h1 className="font-display text-4xl font-bold tracking-tighter text-white mb-1">
                  JAX<span className="text-fuchsia-500">LOCKE</span>
                </h1>
                <p className="text-zinc-400 text-sm tracking-widest uppercase border-l-2 border-fuchsia-500 pl-3">
                  3D Character Artist & Rigger
                </p>
              </div>
              <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-zinc-700 group-hover:border-fuchsia-500 transition-colors">
            ...
            <div className="space-y-4">
               <div className="flex gap-1 flex-wrap text-xs text-zinc-500 font-mono">
                  <span className="bg-zinc-900 px-2 py-1 rounded border border-zinc-800">MAYA</span>
                  <span className="bg-zinc-900 px-2 py-1 rounded border border-zinc-800">BLENDER</span>
                  <span className="bg-zinc-900 px-2 py-1 rounded border border-zinc-800">ZBRUSH</span>
                  <span className="bg-zinc-900 px-2 py-1 rounded border border-zinc-800">UE5</span>
               </div>
            </div>
          ...
          {/* Decorative Elements */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-fuchsia-500/10 blur-3xl -z-10 rounded-full" />
          <div className="absolute bottom-0 left-0 w-40 h-40 bg-indigo-500/10 blur-3xl -z-10 rounded-full" />
        </div>
      </div>
    </div>
  );
